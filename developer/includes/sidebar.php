...
$isUsers = strpos($currentPath, '/developer/users/') === 0;
$isPayments = strpos($currentPath, '/developer/payments/') === 0;
$isSettings = strpos($currentPath, '/developer/settings/') === 0;
?>
    ...
    <div class="h-full flex flex-col p-3 overflow-y-auto">
        <nav class="space-y-1">
            ...
            <a href="/developer/stores/" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm <?= $isStores ? 'bg-neutral-50 font-medium text-neutral-900' : 'text-neutral-500 hover:bg-neutral-50 hover:text-neutral-900' ?>">
                <i data-lucide="store" class="w-4 h-4 <?= $isStores ? 'text-emerald-600' : '' ?>"></i><span>Stores</span>
            </a>
            <a href="/developer/users/" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm <?= $isUsers ? 'bg-neutral-50 font-medium text-neutral-900' : 'text-neutral-500 hover:bg-neutral-50 hover:text-neutral-900' ?>">
                <i data-lucide="user-round" class="w-4 h-4 <?= $isUsers ? 'text-orange-600' : '' ?>"></i><span>Users</span>
            </a>
            ...
            <a href="/developer/payments/" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm <?= $isPayments ? 'bg-neutral-50 font-medium text-neutral-900' : 'text-neutral-500 hover:bg-neutral-50 hover:text-neutral-900' ?>">
                <i data-lucide="credit-card" class="w-4 h-4 <?= $isPayments ? 'text-teal-600' : '' ?>"></i><span>Pembayaran</span>
            </a>
        </nav>
        <div class="mt-auto pt-4 border-t border-neutral-100 space-y-1">
            <a href="/developer/settings/" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm <?= $isSettings ? 'bg-neutral-50 font-medium text-neutral-900' : 'text-neutral-500 hover:bg-neutral-50 hover:text-neutral-900' ?>">
                <i data-lucide="settings" class="w-4 h-4 <?= $isSettings ? 'text-neutral-700' : '' ?>"></i><span>Pengaturan</span>
            </a>
